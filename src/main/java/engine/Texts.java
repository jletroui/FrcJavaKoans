...
public class Texts {
    ...
    public static Localizable<String> EXPECTED_VARIABLE_TO_EQUAL_BUT_IS_NULL =
    ...
    public static Localizable<String> EXPECTED_VARIABLE_TO_EQUAL_BUT_EQUAL =
    ...
    public static Localizable<String> OK_VARIABLE_EQUAL =
