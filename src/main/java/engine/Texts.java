...
public class Texts {
    ...
    public static Local<String> MOUNTAINS_ARE_AGAIN_MERELY_MOUNTAINS =
        local("Mountains are again merely mountains.")
        .fr("Les montagnes sont de nouveau de simples montagnes.");
    public static Local<String> THINKING =
        local("Thinking %s ...")
        .fr("En pensant %s ...");
    public static Local<String> HAS_DAMAGED_YOUR_KARMA =
        local("%s has damaged your karma.")
        .fr("%s a alourdi ton karma.");
    public static Local<String> THE_MASTER_SAYS =
        local("The master says:")
        .fr("Le maître dit:");
    public static Local<String> THE_ANSWERS_YOU_SEEK =
        local("The answers you seek...")
        .fr("Les réponses que tu cherches...");
    public static Local<String> YOU_HAVE_NOT_REACHED_ENLIGHTMENT =
        local("  You have not yet reached enlightment ...")
        .fr("  Tu n'as pas encore atteint l'illumination ...");
    public static Local<String> EXPECTED_METHOD_TO_BE_PUBLIC =
    ...
    public static Local<String> THE_METHOD_APPEARS_TO_PRODUCE_AN_ERROR =
        local("The method %s() appears to produce an error: %s.")
        .fr("La méthode %s() a produit une erreur: %s.");
    public static Local<String> THE_METHOD_SEEMS_TO_NOT_FINISH =
    ...
    public static Local<String> THE_METHOD_SEEMS_TO_RECURSE_INFINITELY =
    ...
    public static Local<String> THE_CONSTRUCTOR_APPEARS_TO_PRODUCE_AN_ERROR =
        local("The constructor of %s appears to produce an error: %s.")
        .fr("Le constructeur de %s a produit une erreur: %s.");
    public static Local<String> EXPECTED_TO_FIND_MEHOD_NO_PARAMS =
    ...
    public static Local<String> EXPECTED_METHOD_TO_BE_STATIC =
    ...
    public static Local<String> EXPECTED_METHOD_TO_NOT_BE_STATIC =
    ...
    public static Local<String> EXPECTED_TO_FIND_MEHOD_RETURN_TYPE =
    ...
    public static Local<String> EXPECTED_TO_FIND_MEHOD_ONE_PARAM =
    ...
    public static Local<String> EXPECTED_TO_FIND_MEHOD_MANY_PARAMS =
    ...
    public static Local<String> EXPECTED_CONSTRUCTOR_TO_BE_PUBLIC =
    ...
    public static Local<String> EXPECTED_TO_FIND_CONSTRUCTOR_NO_PARAMS =
        local("Expected to find a constructor in %s but did not find any.")
        .fr("Attendu à un constructeur dans %s, mais ne le trouve pas.");
    public static Local<String> EXPECTED_TO_FIND_CONSTRUCTOR_ONE_PARAM =
    ...
    public static Local<String> EXPECTED_TO_FIND_CONSTRUCTOR_MANY_PARAMS =
    ...
    public static Local<String> EXPECTED_TO_FIND_A_CLASS_IN_THE_PACKAGE =
    ...
    public static Local<String> THE_MASTER_SENSED_AN_HARMONY_BREACH_WHEN_ANSWERING =
    ...
    public static Local<String> THE_MASTER_SENSED_AN_HARMONY_BREACH_WHEN =
        local("The master sensed the harmony dissolving when:")
        .fr("Le maître a senti l'harmonie se briser en voulant:");
    public static Local<String> WHEN_ANSWERING =
        local("  - planning to answer %s.")
        .fr("  - répondre %s.");
    public static Local<String> WHEN_CALLING =
        local("  - calling %s.")
        .fr("  - appeler %s.");
    public static Local<String> CONSOLE =
        local("Console for %s:")
        .fr("Console pour %s:");
    public static Local<String> YOUR_PROGRESS_THUS_FAR =
    ...
    public static Local<String> AND =
        local(", and %s")
        .fr(" et %s");
    public static Local<String> EXPECTED_TO_FIND_FIELD_IN_CLASS =
    ...
    public static Local<String> BUG_FOUND =
    ...
    public static Local<String> EXPECTED_TO_SEE_EMPTY_LINE_IN_CONSOLE_BUT_SAW_NOTHING =
    ...
    public static Local<String> EXPECTED_TO_SEE_EMPTY_LINE_IN_CONSOLE_BUT_SAW_INSTEAD =
    ...
    public static Local<String> OK_ASKED_FOR_LINE_IN_CONSOLE =
        local("Ok: asked for a line in the console.")
        .fr("Ok: demandé du texte dans la console.");
    public static Local<String> EXPECTED_FOR_USER_TO_ANSWER_IN_CONSOLE =
    ...
    public static Local<String> EXPECTED_TO_RETURN_INT_BUT_RETURNED_NULL =
        local("Expected %s to return %d but returned null instead!")
        .fr("Attendu à ce que %s retourne %d mais a retourné null à la place!");
    public static Local<String> EXPECTED_TO_RETURN_INT_BUT_RETURNED_OTHER_TYPE =
    ...
    public static Local<String> EXPECTED_TO_RETURN_BOOLEAN_BUT_RETURNED =
        local("Expected %s to return %s but returned %s instead!")
        .fr("Attendu à ce que %s retourne %s mais a retourné %s à la place!");
    public static Local<String> OK_RETURNED_BOOLEAN =
        local("Ok: %s returned %s.")
        .fr("Ok: %s a retourné %s.");
    public static Local<String> EXPECTED_TO_RETURN_STRING_BUT_RETURNED_NULL =
        local("Expected %s to return \"%s\" but returned null instead!")
        .fr("Attendu à ce que %s retourne \"%s\" mais a retourné null à la place!");
    public static Local<String> EXPECTED_TO_RETURN_STRING_BUT_RETURNED_OTHER_TYPE =
    ...
    public static Local<String> EXPECTED_TO_RETURN_STRING_BUT_RETURNED =
        local("Expected %s to return \"%s\" but returned \"%s\" instead!")
        .fr("Attendu à ce que %s retourne \"%s\" mais a retourné \"%s\" à la place!");
    public static Local<String> OK_RETURNED_STRING =
        local("Ok: %s returned \"%s\".")
        .fr("Ok: %s a retourné \"%s\".");
    public static Local<String> EXPECTED_TO_RETURN_BUT_RETURNED_NULL =
        local("Expected %s to return %s but returned null instead!")
        .fr("Attendu à ce que %s retourne un %s mais a retourné null à la place!");
    public static Local<String> EXPECTED_TO_RETURN_BUT_RETURNED_OTHER_TYPE =
    ...
    public static Local<String> EXPECTED_TO_RETURN_BUT_RETURNED =
        local("Expected %s to return %s but returned %s instead!")
        .fr("Attendu à ce que %s retourne %s mais a retourné %s à la place!");
    public static Local<String> OK_RETURNED =
        local("Ok: %s returned %s.")
        .fr("Ok: %s a retourné %s.");
    public static Local<String> EXPECTED_TO_LOOK_LIKE_BUT_LOOKED_LIKE =
    ...
    public static Local<String> OK_LOOKED_LIKE =
        local("Ok: object looked like \"%s\".")
        .fr("Ok: l'object ressemble à \"%s\".");
    public static Local<String> EXPECTED_TO_RETURN_INT_FROM_RANDOM_BUT_RETURNED =
    ...
    public static Local<String> OK_RETURNED_INT_FROM_RANDOM =
        local("Ok: %s returned %d from random number %f.")
        .fr("Ok: %s a retourné %d à partir du nombre aléatoire %f.");
    public static Local<String> EXPECTED_TO_RETURN_INT_FROM_RANDOMS_BUT_RETURNED =
    ...
    public static Local<String> OK_RETURNED_INT_FROM_RANDOMS =
        local("Ok: %s returned %d from random numbers %s.")
        .fr("Ok: %s a retourné %d à partir du nombre aléatoire %s.");        
    public static Local<String> EXPECTED_FIELD_TO_BE_PRIVATE =
    ...
    public static Local<String> EXPECTED_FIELD_TO_BE_FINAL =
    ...
    public static Local<String> EXPECTED_FIELD_TO_BE_OF_TYPE =
